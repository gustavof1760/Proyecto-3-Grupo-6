...
#set_property PACKAGE_PIN V10 [get_ports rx_en]						
...
set_property PACKAGE_PIN U11 [get_ports rx_en]					
	set_property IOSTANDARD LVCMOS33 [get_ports rx_en]
...
#set_property PACKAGE_PIN K2 [get_ports AD]					
...
set_property PACKAGE_PIN H4 [get_ports AddressData[1]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[1]]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports AddressData[3]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[3]]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports AddressData[5]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[5]]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
set_property PACKAGE_PIN G3 [get_ports AddressData[7]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[7]]
##Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = JD7
set_property PACKAGE_PIN H2 [get_ports AddressData[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[0]]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
set_property PACKAGE_PIN G4 [get_ports AddressData[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[2]]
##Bank = 35, Pin name = IO_L15N_T2_DQS_35,					Sch name = JD9
set_property PACKAGE_PIN G2 [get_ports AddressData[4]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[4]]
##Bank = 35, Pin name = IO_L13N_T2_MRCC_35,					Sch name = JD10
set_property PACKAGE_PIN F3 [get_ports AddressData[6]]					
	set_property IOSTANDARD LVCMOS33 [get_ports AddressData[6]]
 


##Pmod Header JXADC
##Bank = 15, Pin name = IO_L9P_T1_DQS_AD3P_15,				Sch name = XADC1_P -> XA1_P
#set_property PACKAGE_PIN A13 [get_ports speaker]				
...
set_property PACKAGE_PIN B18 [get_ports speaker]				
	set_property IOSTANDARD LVCMOS33 [get_ports speaker]
